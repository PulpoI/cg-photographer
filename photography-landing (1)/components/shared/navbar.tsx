...
const services = [
  { name: 'Bodas', href: '/services/weddings' },
  { name: '15 Años', href: '/services/sweet-sixteen' },
  { name: 'Infantiles', href: '/services/children' },
  { name: 'Eventos', href: '/services/events' },
  { name: 'Cumpleaños', href: '/services/birthdays' },
  { name: 'Corporativo', href: '/services/corporate' },
]
...
export default function Navbar() {
  ...
  const NavItems = ({ mobile = false }) => (
    <>
      ...
      <Link href="/about" className={cn("text-zinc-400 hover:text-white", mobile ? "text-2xl" : "text-sm")}>
        Sobre Mí
      </Link>
      <div className="relative group">
        <Link href="/services" className={cn("text-zinc-400 hover:text-white", mobile ? "text-2xl" : "text-sm")}>
          Servicios
        </Link>
        <div className={cn(
      ...
      <Link href="/contact" className={cn("text-zinc-400 hover:text-white", mobile ? "text-2xl" : "text-sm")}>
        Contacto
      </Link>
    </>
  )
